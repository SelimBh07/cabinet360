...
$userPrefs = new UserPreferences($conn, $_SESSION['lawyer_id'] ?? 0);
...
<head>
    ...
    <!-- Theme CSS -->
    <link rel="stylesheet" href="<?php echo APP_URL; ?>/assets/css/theme-light.css">
    <link rel="stylesheet" href="<?php echo APP_URL; ?>/assets/css/theme-dark.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo APP_URL; ?>/assets/css/style.css">
    
    <!-- Theme Manager -->
    <script src="<?php echo APP_URL; ?>/assets/js/theme-manager.js" defer></script>
