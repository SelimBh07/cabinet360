...
<div class="page-header">
    ...
    <p class="page-subtitle">Gérez votre profil et les paramètres du cabinet</p>
</div>
...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-building"></i> Informations du Cabinet
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <select class="form-select" id="themeSelect" disabled>
                        <option value="dark" selected>Sombre (Actuel)</option>
                        <option value="light">Clair (Prochainement)</option>
                    </select>
                </div>
